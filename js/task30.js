...
const getTotalBalanceByGender = (users, gender) => {
    ...
    const balanceFilterGender = filterGender.map(user => user.balance);
    console.log("balanceFilterGender", balanceFilterGender);
    const totalBalance = balanceFilterGender.reduce((previousValue, number) => {
